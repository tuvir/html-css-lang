...
- Navigation: all sections menu + logo
- Hero: branding, summary
- Fetured in
- How it works: gallery
- Diet list + meals
- See more: gallery + testimonials: carousel
- Pricing plans: product plates + features
- Call to action: free sample meal registration form
- Footer: contacts, SM links, other links
